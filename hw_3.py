#1) Создайте вручную список из 15 элементов (название городов, музыки,
#машины). Сделайте срез от 2-го индекса до 7-го

# lst = ['Toyota', 'Hammer', 'Jeep', 'LandCruiser', 'Nissan Skyline', 'Silvia', 'California',
# 'Albuquercue', 'Rip Luv', 'Everybody Dies In Nightmere', 'Prayer in C', 'Antarctica', 'Osh', 'Texas', 'Florida']
# print(lst[2:7])
...
# playlist = ["Эсимде", "Черные глаза", "Мой кайф", "Не по пути", "OLD BLOOD", "ANTARCTICA", 
# "Chlorine", "Heathens", "RIP LUV", "Teen Romance"]
# playlist[4] = "RIP LUV"
# playlist[8] = "OLD BLOOD"
# print(playlist)
